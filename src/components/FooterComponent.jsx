        ...
        <div className="flex gap-10 flex-col mx-3 lg:mx-7 lg:w-1/2 ">
          ...
          <div className="flex flex-col gap-4">
            <div className="flex items-center justify-between">
              ...
              <p className="bg-sky-500 px-3 py-1 rounded-md">Indonesia</p>
            </div>
            <hr className="w-full" />
          ...
          <div className="flex flex-col gap-4">
            ...
            <hr className="w-full" />
            <animated.div style={translateY} className="flex flex-col gap-4">
              <Link to={"#home"} className="duration-300 hover:bg-sky-700 hover:px-10 hover:py-2 hover:rounded-md">
                Home
              </Link>
              <Link to={"#service"} className="duration-300 hover:bg-sky-700 hover:px-10 hover:py-2 hover:rounded-md">
                Service
              </Link>
          ...
          <form className="border flex flex-col gap-4 p-5 rounded-md text-black w-full" onSubmit={handleSubmit}>
            ...
            <div className="flex flex-col gap-2">
              ...
              <input
                ...
                className="border border-gray-300 px-4 py-2 rounded-md w-full focus:outline-none focus:border-sky-500 focus:border-2"
            ...
            <div className="flex flex-col gap-2">
              ...
              <input
                ...
                onChange={handleChange}
                className="border border-gray-300 px-4 py-2 rounded-lg w-full focus:outline-none focus:border-sky-500 focus:border-2"
            ...
            <div className="flex flex-col gap-2">
              ...
              <select
                ...
                onChange={handleChange}
                className="border border-gray-300 bg-sky-700 px-3 py-2 rounded-lg text-white w-full focus:outline-none focus:border-sky-500 focus:border-2"
                required
              >
            ...
            {/* Button Submit */}
            <button type="submit" className="bg-sky-500 border-2 border-sky-500 duration-300 py-1 rounded-md text-white hover:bg-sky-700 hover:border-y-sky-700">
              Submit
            </button>
          </form>
        </div>
