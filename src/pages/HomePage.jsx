...
const HomePage = () => {
  ...
  return (
    <Layout id="home">
        ...
        <div className="flex flex-col gap-10 items-center justify-center max-w-7xl px-3 py-28 md:py-32 md:px-7">
          ...
          <div className="flex flex-col gap-10 items-center justify-between w-full md:flex-row md:gap-0">
            <div className="flex flex-col gap-4 items-start justify-center w-full md:w-1/2">
              <p className="font-bold text-3xl lg:text-4xl" data-aos-duration="100" data-aos-offset="120" data-aos="fade-down">
                A Brief Insight <span className="text-blue-500">Drafire Tech Development</span>
              </p>
              <p className="border-2 border-blue-500 p-4 rounded-md text-justify" data-aos-duration="100" data-aos-offset="120" data-aos="fade-right">
              ...
              <div className="flex items-center gap-4 w-full" data-aos-duration="100" data-aos-offset="120" data-aos="fade-up">
                ...
                <div className="flex gap-4 items-start justify-start text-start w-auto">
            ...
            <div className="flex items-center justify-center w-full md:w-1/2" data-aos-duration="100" data-aos-offset="120" data-aos="flip-left">
              <img src="../profile/img-about.png" alt="img-about" className="w-72" />
            </div>
          </div>

          {/* Row 2 - Dashboard Count */}
          <div className="flex flex-col gap-4 font-bold items-center justify-between text-white w-full md:flex-row" data-aos-duration="100" data-aos-offset="120" data-aos="fade-down">
          ...
          <div className="flex flex-col gap-10 items-center justify-around w-auto">
            <p className="font-bold text-3xl md:text-4xl" data-aos-duration="100" data-aos-offset="120" data-aos="fade-down">
            ...
            <div className="flex flex-wrap gap-10 items-start justify-center w-auto md:flex-row">
              {/* Fadilano Abraham */}
              <div className="border-2 border-blue-500 flex flex-col gap-1 items-center p-5 rounded-md w-full md:w-auto" data-aos-duration="100" data-aos-offset="120" data-aos="fade-down-right">
              ...
              {/* Raihan Darrel A */}
              <div className="border-2 border-blue-500 flex flex-col gap-1 items-center p-5 rounded-md w-full md:w-auto" data-aos-duration="100" data-aos-offset="120" data-aos="fade-down">
                <div className="flex flex-col gap-1 items-center justify-center">
              ...
              {/* Muhammad Ridwan */}
              <div className="border-2 border-blue-500 flex flex-col gap-1 items-center p-5 rounded-md w-full md:w-auto" data-aos-duration="100" data-aos-offset="120" data-aos="fade-down-left">
                <div className="flex flex-col gap-1 items-center justify-center">
              ...
              {/* Achmad Rizky */}
              <div className="border-2 border-blue-500 flex flex-col gap-1 items-center p-5 rounded-md w-full md:w-auto" data-aos-duration="100" data-aos-offset="120" data-aos="fade-up-right">
                <div className="flex flex-col gap-1 items-center justify-center">
              ...
              {/* M. Rayhan Pasyaputra */}
              <div className="border-2 border-blue-500 flex flex-col gap-1 items-center p-5 rounded-md w-full md:w-auto" data-aos-duration="100" data-aos-offset="120" data-aos="fade-up">
                <div className="flex flex-col gap-1 items-center justify-center">
              ...
              <div className="border-2 border-blue-500 flex flex-col gap-1 items-center p-5 rounded-md w-full md:w-auto" data-aos-duration="100" data-aos-offset="120" data-aos="fade-up-left">
                <div className="flex flex-col gap-1 items-center justify-center">
          ...
          <div className="flex flex-col gap-10 items-center justify-center w-auto">
            ...
            <div className="flex flex-wrap gap-10 items-center justify-around" data-aos-duration="100" data-aos-offset="120" data-aos="fade-down">
              <img src="../patners/shopee.png" alt="shopee" data-aos-duration="100" data-aos-offset="120" data-aos="fade-up-right" />
              <img src="../patners/kominfo.png" alt="kominfo" data-aos-duration="100" data-aos-offset="120" data-aos="fade-up-right" />
              <img src="../patners/traveloka.png" alt="traveloka" data-aos-duration="100" data-aos-offset="120" data-aos="fade-down-left" />
              <img src="../patners/bluebird.png" alt="bluebird" data-aos-duration="100" data-aos-offset="120" data-aos="fade-down-left" />
              <img src="../patners/gojek.png" alt="gojek" data-aos-duration="100" data-aos-offset="120" data-aos="fade-right" />
              <img src="../patners/garudaindonesia.png" alt="garudaindonesia  " data-aos-duration="100" data-aos-offset="120" data-aos="zoom-in" />
              <img src="../patners/tokopedia.png" alt="tokopedia" data-aos-duration="100" data-aos-offset="120" data-aos="fade-left" />
              <img src="../patners/toyota.png" alt="toyota" data-aos-duration="100" data-aos-offset="120" data-aos="fade-up" />
              <img src="../patners/unitedtractors.png" alt="unitedtractors" data-aos-duration="100" data-aos-offset="120" data-aos="fade-up" />
            </div>
          </div>
        </div>
      </section>
      ...
      <section id="service" className="font-poppins tracking-wider text-slate-700 ">
        <div className="bg-blue-100 flex flex-col gap-10 items-start justify-center max-w-7xl px-3 py-28 md:py-32 md:px-7">
          ...
          <div className="bg-white flex flex-col items-start justify-center gap-10 p-5 rounded-md shadow-lg w-full md:flex-row">
            <div className="border-2 border-blue-500 flex flex-col items-center justify-center rounded-md w-full md:w-72" data-aos-duration="100" data-aos-offset="120" data-aos="fade-right">
              <Link
                to={"#!"}
      ...
      {/* Project - Done */}
      <section id="project" className="font-poppins tracking-wider text-slate-700" data-aos-duration="100" data-aos-offset="120" data-aos="fade-down">
